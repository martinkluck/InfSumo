<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Accesorios.aspx.cs" Inherits="Accesorios" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContenedorRojo" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:InfSumoConnectionString %>" SelectCommand="SELECT [CodArt_A] as Código, [Descripcion], [PrecioUnitario], [Stock], [Categoria] FROM [Articulos] WHERE [Articulos].[Categoria]='Accesorios'"></asp:SqlDataSource>
</asp:Content>
